...
const SubMenuLink = ({
  ...
  return (
    <a
      className="flex flex-row gap-4 p-3 leading-none no-underline transition-colors rounded-md outline-none select-none hover:bg-muted hover:text-accent-foreground"
      href={item.url}>
