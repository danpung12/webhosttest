  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-[#F9FAFB] ">
        <div >
          <h2 className="text-4xl font-black pt-26">회원가입</h2>
          <div className="mt-4 text-lg font-[350] text-[#4B5563]">이미 회원이신가요?{" "}
          ...
          <div className="w-full space-y-8">
            ...
            <div className="flex justify-between w-full">
              <div className="flex items-center">
                ...
                <div className="ml-2 text-lg text-[#111827]">다음 약관에 동의합니다.</div>
              </div>
